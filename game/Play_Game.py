...
# 스테이지 만들기
stage = pygame.image.load(resource_path("game/stage.png"))
stage_size = stage.get_rect().size
stage_height = stage_size[1] # 스테이지의 높이 위에 캐릭터를 두기 위해 사용

# 캐릭터 만들기
char = pygame.image.load(resource_path("game/character.png"))
...
# 무기 만들기 (위로 쏘는 무기)
weapon = pygame.image.load(resource_path("game/weapon.png"))
...
ball_images = [
    pygame.image.load(resource_path("game/Balloon1.png")),
    pygame.image.load(resource_path("game/Balloon2.png")),
    pygame.image.load(resource_path("game/Balloon3.png")),
    pygame.image.load(resource_path("game/Balloon4.png")),
]
